...
public class TestCase_CheckETResults extends TestSuiteBase {
	...
	public void checkTestSkip() throws Exception
	 {	 
		TestUtil.checkTestSkip("ReportsSuite","TestCase_CheckETResults");
	 }	 
	
	@Test
	public void CheckETResults() throws Exception
	{	
	 ...
	 ReportUtil.ClickOnETResult();
	 ReportUtil.CheckOptionAndView();
	 ReportUtil.ClickOnPagination();
	 ReportUtil.ActualReportValues();
	 ReportUtil.CompareReportValues();	 
