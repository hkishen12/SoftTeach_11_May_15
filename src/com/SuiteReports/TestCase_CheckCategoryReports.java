...
public class TestCase_CheckCategoryReports extends TestSuiteBase {
	...
	public void checkTestSkip() throws Exception
	 {	 
		TestUtil.checkTestSkip("ReportsSuite","TestCase_CheckCategoryReports");
	 }	 
	
	@Test
	public void CheckCategoryReports() throws Exception
	{	
		...
		ReportUtil.ClickOnCategoryReport();
		ReportUtil.SelectOptionForCategoryReports();
		ReportUtil.ActualCatReportValues();
		ReportUtil.CompareCatReportValues();
