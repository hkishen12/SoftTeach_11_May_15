...
public class TestCase_FolderAndCategorySearch extends TestBase
{
	...
	{	 
		TestUtil.checkTestSkip("QuestionsSuite","TestCase_FolderAndCategorySearch");
	}	 


	@Test
	public void verifyFolderAndCategorySearch(){
		QuestionUtil.ClickOnQuestionsTab();
		QuestionUtil.checkSearch("Folder", "ITEMS");
		elementExists(OR.getProperty("QS_QsbyCategoriesLink")).click();
		waitInSeconds(2);
		QuestionUtil.checkSearch("Category", "CATEGORIES");
	}
