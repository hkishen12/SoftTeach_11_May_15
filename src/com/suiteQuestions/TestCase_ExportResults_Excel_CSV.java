...
public class TestCase_ExportResults_Excel_CSV extends TestBase
{
	...
	{	 
		TestUtil.checkTestSkip("QuestionsSuite","TestCase_ExportResults_Excel_CSV");
	}	 
	...
	public void verifyExportResults_Excel_CSV() throws Exception
	{
		...
		QuestionUtil.checkExportResults_Excel_CSV("csv", "ExportedGridData.csv");
		QuestionUtil.checkExportResults_Excel_CSV("excel", "ExportedGridData.xls");
	}
