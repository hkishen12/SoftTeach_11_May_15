...
public class TestCase_CreateTFQuestions extends TestBase
{
	...
	{	 
		TestUtil.checkTestSkip("QuestionsSuite","TestCase_CreateTFQuestions");
	}	 


	@Test
	public void verifyCreateTFQuestionsTest() throws Exception
	{
		String test_Folder = CONFIG.getProperty("QS_CreateQSFolderName");
		if(!test_Folder.matches(".*\\d+.*"))
			test_Folder="ITEMS";
		String questionType="TF";
		String QStitle=Data.getProperty("QuestionTitle4");
