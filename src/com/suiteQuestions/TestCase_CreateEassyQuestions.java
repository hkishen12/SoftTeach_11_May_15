...
public class TestCase_CreateEassyQuestions extends TestBase
{
	...
	{	 
		TestUtil.checkTestSkip("QuestionsSuite","TestCase_CreateEassyQuestions");
	}	 


	@Test
	public void verifyCreateEssayQuestionsTest() throws Exception
	{
		...
		String QStitle=Data.getProperty("QuestionTitle3");
