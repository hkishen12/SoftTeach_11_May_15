...
public class TestCase_CreateFITBQuestions extends TestBase
{
	...
	{	 
		TestUtil.checkTestSkip("QuestionsSuite","TestCase_CreateFITBQuestions");
	}	 


	@Test
	public void verifyCreateFITBQuestionsTest() throws Exception
	{
		String test_Folder = CONFIG.getProperty("QS_CreateQSFolderName");
		if(!test_Folder.matches(".*\\d+.*"))
			test_Folder="ITEMS";
		String questionType="FITB";
		String QStitle=Data.getProperty("QuestionTitle2");
