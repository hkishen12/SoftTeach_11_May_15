...
public class TestCase_DeleteExamTaker extends TestSuiteBase
{
	...
	@Test
	public void DeleteET() throws Exception
	{			
		...
		ExamTakerUtil.doSearchByAnyOption("StudentID", ETID);
		ExamTakerUtil.ClickOnDeleteET();
