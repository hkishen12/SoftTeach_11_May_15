...
public class TestCase_VerifyErrorMsg5_CreateExamTaker extends TestSuiteBase
{
	...
	{	 
		TestUtil.checkTestSkip("ExamTakerSuite","TestCase_VerifyErrorMsg5_CreateExamTaker");
	}	 


	@Test
	public void CreateNewETwithoutAnyField() throws Exception
	{			
		System.out.println("ExamTaker Accessible from Excel");
		ExamTakerUtil.ClickOnExamTakerTab();
		ExamTakerUtil.ClickOnCreateET();
		ExamTakerUtil.doCreateET();
