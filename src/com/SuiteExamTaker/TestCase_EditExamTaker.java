...
public class TestCase_EditExamTaker extends TestSuiteBase
{
	...
	{	 
		TestUtil.checkTestSkip("ExamTakerSuite","TestCase_EditExamTaker");
	}	 


	@Test
	public void EditET() throws Exception
	{			
		...
		ExamTakerUtil.ClickOnEditET();
		ExamTakerUtil.doEditET();
