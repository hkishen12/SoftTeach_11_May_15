...
public class TestCase_CancelCreateExamTaker extends TestSuiteBase
{
	...
	{	 
		TestUtil.checkTestSkip("ExamTakerSuite","TestCase_CancelCreateExamTaker");
	}	 


	@Test
	public void CancelCreateNewET() throws Exception
	{			
		System.out.println("ExamTaker Accessible from Excel");
		ExamTakerUtil.ClickOnExamTakerTab();
		ExamTakerUtil.ClickOnCreateET();
		ExamTakerUtil.doCancelCreateET();
	}
