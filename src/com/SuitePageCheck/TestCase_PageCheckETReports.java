...
public class TestCase_PageCheckETReports extends TestSuiteBase {
	...
	public void checkTestSkip() throws Exception
	 {	 
		TestUtil.checkTestSkip("PageCheckSuite","TestCase_PageCheckETReports");
	 }	 
	
	@Test
	public void PageCheckETReports() throws Exception
	{	
		...
		PageCheckUtil.ClickOnETResult();
		PageCheckUtil.CompareNameETReport();
	}
