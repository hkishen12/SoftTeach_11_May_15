...
public class TestCase_DeleteRubric extends TestBase
{
	...
	{	 
		TestUtil.checkTestSkip("RubricsSuite","TestCase_DeleteRubric");
	}	 


	@Test
	public void VerifyDeleteRubric() throws Exception
	{
