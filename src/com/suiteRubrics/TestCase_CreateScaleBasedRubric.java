...
public class TestCase_CreateScaleBasedRubric extends TestBase
{
	...
	{	 
		TestUtil.checkTestSkip("RubricsSuite","TestCase_CreateScaleBasedRubric");
	}	 


	@Test
	public void VerifyCreateScaleBasedRubric() throws Exception
	{
