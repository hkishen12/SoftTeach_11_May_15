...
public class TestCase_ExportCourseData extends TestSuiteBase {
	...
	{	 
		TestUtil.checkTestSkip("CoursesSuite","TestCase_ExportCourseData");
	}	 

	@Test
	public void ExportCourseData() throws Exception
	{		
		...
		CourseUtil.assignETtoCourse(); 
		CourseUtil.clickOnCourseTab();
		CourseUtil.searchCoursebyID(CourseID);
		CourseUtil.exportCoursedata();
	}
