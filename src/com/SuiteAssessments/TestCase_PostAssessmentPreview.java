...
public class TestCase_PostAssessmentPreview extends TestSuiteBase
{
	// Runmode of test case in a suite
	@BeforeTest
	public void checkTestSkip() throws Exception
	{	 
		TestUtil.checkTestSkip("AssessmentsSuite","TestCase_PostAssessmentPreview");
	}	 


	@Test
	public void PostAssessmentPreview() throws Exception
	{			
		...
		//AssessmentUtil.doSearchAssessmentInfolder();
