...
public class TestCase_PostAssessment extends TestSuiteBase
{
...
public void checkTestSkip() throws Exception
 {	 
	TestUtil.checkTestSkip("AssessmentsSuite","TestCase_PostAssessment");
 }	 


@Test
public void PostAssessment() throws Exception
	{		
	...
	AssessmentUtil.doSearchAssessment(CONFIG.getProperty("ATitle_string"));
	AssessmentUtil.doPostassessmentchecking();
